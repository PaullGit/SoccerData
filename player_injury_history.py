...
read = pd.read_csv("player_ids.csv")
players = read["IDs"].tolist()
...
for player in players:
    page =  f"https://www.transfermarkt.com/erling-haaland/verletzungen/spieler/{player}"
    pageTree = requests.get(page, headers=headers)
    pageSoup = BeautifulSoup(pageTree. content, 'html.parser')
    result = f.GetPlayerInjuryHistory(player, pageSoup)
k
